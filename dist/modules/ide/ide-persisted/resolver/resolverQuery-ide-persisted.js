...
exports.default = {
  idePersistedFindAll: function () {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              ls(_constants.PERSISTED_DIRECTORY);
                    ...
                    while (1) {
                      switch (_context.prev = _context.next) {
                        case 0:
                          _context.prev = 0;
                          _context.next = 3;
                          return fs.readFileAsync(_constants.PERSISTED_DIRECTORY + '/' + file, 'utf8');
    ...
    return function idePersistedFindAll(_x, _x2, _x3) {
...
//# sourceMappingURL=resolverQuery-ide-persisted.js.map